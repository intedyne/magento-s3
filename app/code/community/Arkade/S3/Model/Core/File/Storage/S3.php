...
class Arkade_S3_Model_Core_File_Storage_S3 extends Mage_Core_Model_File_Storage_Abstract
{
    protected $_eventPrefix = 'arkade_s3_core_file_storage_s3';
    ...
    {
        $this->_init('arkade_s3/core_file_storage_s3');
    }
    ...
    {
        return Mage::helper('arkade_s3')->__('S3');
    }
